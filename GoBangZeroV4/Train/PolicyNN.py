...
class ResidualCNN():
    ...
    def __init__(self, input_dim, output_dim, hidden_layers={"filters": 64, "kernel_size": (3, 3)}, num_layers=5):
    ...
    def BuildModel(self):
        ...
        conv = self.ConvLayer(input, 32, self.kernel_size)

        # 添加额外的卷积层
        conv = self.ConvLayer(conv, 64, self.kernel_size)  # 第一层额外卷积层
